...
- [baris-inandi/bfgo](https://github.com/baris-inandi/bfgo) - A fast, optimizing, BF compiler, interpreter, and REPL. Also includes a BF formatter and minifier! Implemented in Go. Batteries included.
...
- [frncsdrk/avatar](https://github.com/frncsdrk/avatar) - Self-hosted service for creating random avatars. Development moved to codeberg.
...
- [crisdosaygo/jspaint.exe](https://github.com/crisdosaygo/jspaint.exe) - 🌂JS Paint ~~ as a cross-platform native desktop app. In other words, the "🎨 Classic MS Paint, ＲＥＶＩＶＥＤ + ✨Extras".exe hehe
...
- [xefi/faker-php](https://github.com/xefi/faker-php) - Generate fake data on demand.
...
- [diego-ninja/granite](https://github.com/diego-ninja/granite) - A not-so-simple library to build immutable and serializable objects
...
- [samuelgfeller/slim-example-project](https://github.com/samuelgfeller/slim-example-project) - Real World Slim 4 Example Project with Front- and Backend, Testing, Auth, Permissions, Localization and more with a complete documentation.
...
- [RamyHakam/multi_tenancy_bundle](https://github.com/RamyHakam/multi_tenancy_bundle) - Symfony  6 / 7 bundle to support multi-tenants
...
- [benholmen/defrag](https://github.com/benholmen/defrag) - Disk defrag output for PHPUnit tests
...
- [TomasVotruba/lines](https://github.com/TomasVotruba/lines) - CLI tool for quick size measure of PHP project, used PHP features and more. Zero dependencies. Runs anywhere
...
- [lucasdotvin/laravel-soulbscription](https://github.com/lucasdotvin/laravel-soulbscription) - A straightforward interface to handle subscriptions and feature consumption.
...
- [elastic/apm-agent-php](https://github.com/elastic/apm-agent-php) - 
...
- [Orbitale/PermissionsBundle](https://github.com/Orbitale/PermissionsBundle) - Use expression based permissions instead of roles or voters to simplify your security in Symfony. Feel free to contribute ! :+1: Project was initiated after this discussion: https://github.com/symfony
...
- [Behat/CommonContexts](https://github.com/Behat/CommonContexts) - ARCHIVED - Common FeatureContext classes for Behat 2.x
...
- [streamdeck-linux-gui/streamdeck-linux-gui](https://github.com/streamdeck-linux-gui/streamdeck-linux-gui) - A Linux compatible UI for the Elgato Stream Deck.
...
- [pkkid/x11pygrid](https://github.com/pkkid/x11pygrid) - Quickly move windows around the an X11 desktop
...
- [Aupajo/pdffonts](https://github.com/Aupajo/pdffonts) - A command-line tool to list fonts embedded inside PDF documents.
...
- [laradumps/laradumps-docs](https://github.com/laradumps/laradumps-docs) - 🛻 LaraDumps Core is a friendly app designed to boost your PHP coding and debugging experience.
...
- [vinayakkulkarni/v-mapbox](https://github.com/vinayakkulkarni/v-mapbox) - Vue 3 wrapper for Mapbox GL & MapLibre GL JS with declarative component API.
...
- [bimdata/platform-old](https://github.com/bimdata/platform-old) - BIMData Platform is a web application to manage your project in the BIM ecosystem
